...
public class AES128 {
    String pesan;
    String kunci;
    public String[][] pesanHEX = new String[4][4]; //matrix pesan
    public String[][] kunciHEX = new String[4][4]; //matrix kunci
    public String[][][] roundKey = new String[11][4][4]; //matrix round key
    ...
    public AES128(String p, String k){
    ...
    public String getPesan(){
        ...
        for(int y=0; y<4; y++){
            for(int x=0; x<4; x++){
                pesan=pesan+(char)Integer.parseInt(pesanHEX[x][y], 16 );
            }
        }
        return pesan;
    }
